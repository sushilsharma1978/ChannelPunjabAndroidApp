...
public class Videowebview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoView.setVideoURI(Uri.parse("http://chpunjab.punjabivision.tv/pjb.m3u8"));
        //videoView.setVideoURI(Uri.parse("https://5c75277727cd1.streamlock.net/deshamtv/deshamtv/playlist.m3u8"));
